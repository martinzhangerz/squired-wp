...
function ccfm_options_do_page() {
    ...
    <div class="ccfm-settings wrap">
        ...
        <div class="notice notice-info is-dismissible ccfm-notice-hosting"> 
        ...
        <form id="cchim" method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top"><th scope="row"><?php _e( 'Required capability to see the button on dashboard.', 'ccfm' ); ?></th>
                    <td>
