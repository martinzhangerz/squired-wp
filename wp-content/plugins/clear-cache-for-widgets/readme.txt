...
Similarly, if you are using the LiteSpeed Cache plugin, you can add the following (untested) code.  I don't have a LiteSpeed server so I'm unable to verify this actually works.
